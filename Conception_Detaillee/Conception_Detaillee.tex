...
\begin{algorithme}
	...
	\sialorssinon{nbCoups(coupsPossibles) $>$ 0}
		{
		\affecter{resultat}{scoreDUnCoup(plateau,iemeCoup(coupsPossibles,1),couleurRef,couleurCourante,\\\big[profondeurCourante)}
		\pour{i}{2}{nbCoups(coupsPossibles)}{}
			{
			\affecter{score}{scoreDUnCoup(plateau,iemeCoup(coupsPossibles,i),couleurRef,couleurCourante,\\\big[profondeurCourante)}
