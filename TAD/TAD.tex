...
\end{tadOperations}
\begin{tadAxiomes}
\tadAxiome{\emph{estCaseVide(creerPlateau(taille),Position)=VRAI}}
...
\tadAxiome{\emph{retournerPion(retournerPion(Plateau,Position),Position)=Plateau}}
\end{tadAxiomes}
...
\begin{tad}
	...
	\begin{tadPreconditions}{iemeCoup}
		\tadPrecondition{iemeCoup}{i$\leqslant$nbCoups(cps)}		
	\end{tadPreconditions}
\end{tad}
