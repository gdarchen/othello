...
\begin{algorithme}
	...
	couleurAdversaire : Couleur}
	{
		...
		}
		{
			...
			\affecter{pos}{fixerPosition(2*x+i, 2*y+j)}
...
\fonction{evaluerNbCoupsPossiblesAdversaire}
	...
	couleurAdversaire : Couleur}
	{
	  ...
	  \affecter{res}{60-10*nbCoupsAdversaire}
	  \retourner{res}  
	}
...
\fonction{evaluerPositionsPionsPlateau}
	...
	i, j, x, y : \naturel \\
	pos : Position \\
	grilleScore : Tableau[1..8][1..8] d'\entier}
	{
	  ...
	  \pour{i}{1}{8}{}{
	    \pour{j}{1}{8}{}{
	      ...
	      \sialorssinon{non estCaseVide(plateau,pos) et sontEgales(obtenirCouleur(obtenirPion(pos)),couleur)}{
		\affecter{resJoueur}{resJoueur+grilleScore[i-1][j-1]}
	      }
	      {
