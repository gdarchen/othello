...
\usepackage{multirow}
\usepackage{Packages/algorithmeUTF8}
...
\lstdefinestyle{customc}{
  ...
  morekeywords ={Coup, Coups, Pion, Plateau, Position, Direction, }
...
\input{./PartiesDuRapport/1_TAD/TAD.tex}
...
\input{./PartiesDuRapport/3_Conception_Preliminaire/Conception_Preliminaire.tex}

\setcounter{chapter}{0}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Conception détaillée %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Conception détaillée}
\input{./PartiesDuRapport/4_Conception_Detaillee/Conception_Detaillee.tex}

\setcounter{chapter}{0}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Developpement %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Développement}

\input{./PartiesDuRapport/5_Developpement/Developpement.tex}
