...
\signatureprocedure{inverserDiagMontante}{\paramEntree{position : Position, pionJoueur : Pion}, \paramEntreeSortie{plateau : Plateau}}
\signatureprocedure{inverserDiagDescendante}{\paramEntree{position : Position, pionJoueur : Pion}, \paramEntreeSortie{plateau : Plateau}}
...
\signaturefonction{minMax}{plateau : Plateau, coupsPossibles : Coups, couleur : Couleur, profondeur : \naturel}{\entier}
\signaturefonction{scoreDUnCoup}{plateau : Plateau, couleur : Couleur}{\entier}
\signaturefonction{coupGagnant}{plateau : Plateau, coup : Coup, couleur : Couleur}{\booleen}
\signaturefonction{score}{plateau : Plateau, couleur : Couleur}{\naturel}
\signaturefonction{evaluerPlateau}{}{}
\end{itemize}
